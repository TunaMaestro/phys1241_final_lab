...
\includegraphics[width=1\textwidth]{setup_for_double_slit.png}
...
\includegraphics[width=1\textwidth]{setup_picture.jpg}
...
The analysis would have continued to a comparison between theoretical and empirical data, however this was not conducted due to the poor data gathered.
...
The synchronisation data that was derived from the screen recordings are in the \nameref{tab:SynchronisationTable}.
...
\subsection*{Contigency Experiment}
...
\begin{wrapfigure}{r}{0.45\textwidth}
	\centering
	\includegraphics[width=0.4\textwidth]{trial_4_one_sweep_annotated.png}
